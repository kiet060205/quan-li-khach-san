...
import { Table, Card, Typography, Button, Space, Rate, Modal, message, Avatar, Tag, Row, Col, Input, Divider, Progress } from 'antd';
import { DeleteOutlined, ReloadOutlined, UserOutlined, StarOutlined, MessageOutlined, CheckOutlined } from '@ant-design/icons';
